...
CREATE TABLE [Administracion].[Medico] (
    ...
    [esDirector]       BIT           NULL,
    [rowversion]       TIMESTAMP     NOT NULL,
    CONSTRAINT [PK_Medico] PRIMARY KEY CLUSTERED ([DNI_Medico] ASC)
);
...
BEGIN
    ...
    SELECT vm.codHospital,
           vm.idServicio,
           hc.DNI_Paciente,  -- Se obtiene desde HistoriaClinica en vez de codHist
           vm.DNI_Medico,
           vm.num_habitacion,
           vm.fecha_hora,
           vm.fecha_alta,
    ...
    LEFT JOIN Pacientes.HistoriaClinica hc ON vm.codHist = hc.codHist
