...
-- 4. Insertar pacientes (No tiene dependencias)
...
-- 5. Relación hospital-servicio (Depende de hospitales y servicios)
...
-- 6. Relación médico-servicio (Depende de médicos, hospitales y servicios)
...
FROM (VALUES 
    ...
    (199, '55201866'),
    (94, '65893668')
) AS TempTable(codHist, DNI_Paciente)
WHERE NOT EXISTS (
    SELECT 1 FROM Pacientes.HistoriaClinica hc WHERE hc.codHist = TempTable.codHist
);
