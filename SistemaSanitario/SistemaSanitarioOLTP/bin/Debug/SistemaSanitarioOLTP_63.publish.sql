...
IF EXISTS (select top 1 1 from [Administracion].[Medico])
...
GO
ALTER TABLE [Administracion].[Medico] DROP CONSTRAINT [DF__Medico__esDirect__44FF419A];
...
GO
PRINT N'Quitando Clave externa [Administracion].[FK_Medico_Medico_Servicio]...';


GO
ALTER TABLE [Administracion].[Medico_Servicio] DROP CONSTRAINT [FK_Medico_Medico_Servicio];


GO
PRINT N'Quitando Clave externa [Pacientes].[FK_Medico_VisitaMedica]...';


GO
ALTER TABLE [Pacientes].[VisitaMedica] DROP CONSTRAINT [FK_Medico_VisitaMedica];
...
CREATE TABLE [Administracion].[tmp_ms_xx_Medico] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Medico1] PRIMARY KEY CLUSTERED ([DNI_Medico] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [Administracion].[Medico])
    BEGIN
        INSERT INTO [Administracion].[tmp_ms_xx_Medico] ([apellidos_nombre], [fecha_nacimiento], [codHospital], [esDirector])
...
ALTER TABLE [Administracion].[Hospital] WITH NOCHECK
    ADD CONSTRAINT [FK_Hospital_Medico] FOREIGN KEY ([DNI_Director]) REFERENCES [Administracion].[Medico] ([DNI_Medico]) ON DELETE SET NULL;
...
ALTER TABLE [Administracion].[Medico_Servicio] WITH NOCHECK
    ADD CONSTRAINT [FK_Medico_Medico_Servicio] FOREIGN KEY ([DNI_Medico]) REFERENCES [Administracion].[Medico] ([DNI_Medico]) ON DELETE CASCADE;
...
ALTER TABLE [Pacientes].[VisitaMedica] WITH NOCHECK
    ADD CONSTRAINT [FK_Medico_VisitaMedica] FOREIGN KEY ([DNI_Medico]) REFERENCES [Administracion].[Medico] ([DNI_Medico]);
...
END
GO
PRINT N'Creando Procedimiento [dbo].[GetVisitaMedicaChangesByRowVersion]...';
