...
GO
PRINT N'Modificando Tabla [Administracion].[Hospital]...';
...
GO
PRINT N'Modificando Tabla [Administracion].[Medico]...';
...
GO
PRINT N'Modificando Tabla [Administracion].[Medico_Servicio]...';


GO
ALTER TABLE [Administracion].[Medico_Servicio]
    ADD [rowversion] TIMESTAMP NOT NULL;


GO
PRINT N'Modificando Tabla [Pacientes].[HistoriaClinica]...';


GO
ALTER TABLE [Pacientes].[HistoriaClinica]
    ADD [rowversion] TIMESTAMP NOT NULL;


GO
PRINT N'Modificando Tabla [Pacientes].[Paciente]...';
...
GO
PRINT N'Modificando Tabla [Pacientes].[VisitaMedica]...';


GO
ALTER TABLE [Pacientes].[VisitaMedica]
    ADD [rowversion] TIMESTAMP NOT NULL;


GO
PRINT N'Modificando Tabla [Servicios].[Hospital_Servicio]...';
...
GO
PRINT N'Modificando Tabla [Servicios].[Servicio]...';
