...
GO
PRINT N'Quitando Restricción UNIQUE restricción sin nombre en [dbo].[Dim_Paciente]...';


GO
ALTER TABLE [dbo].[Dim_Paciente] DROP CONSTRAINT [UQ__Dim_Paci__7C32F73B2ECE03A9];
