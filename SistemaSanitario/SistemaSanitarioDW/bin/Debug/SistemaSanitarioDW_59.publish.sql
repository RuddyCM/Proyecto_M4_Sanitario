...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK__Fact_Visi__Pacie__4D94879B];
...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK__Fact_Visi__Medic__4E88ABD4];
...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK__Fact_Visi__Hospi__4F7CD00D];
...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK__Fact_Visi__Servi__5070F446];
