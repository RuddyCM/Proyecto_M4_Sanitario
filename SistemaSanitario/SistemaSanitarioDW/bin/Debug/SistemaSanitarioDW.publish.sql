...
CREATE TABLE [dbo].[Dim_Medico] (
    ...
    [codHospital]        VARCHAR (20)  NULL,
    [direccion_hospital] TEXT          NULL,
    [es_director]        BIT           NULL,
    PRIMARY KEY CLUSTERED ([DNI_Medico] ASC)
);
...
CREATE TABLE [dbo].[Dim_Paciente] (
    ...
    [apellidos_nombre]     VARCHAR (255) NULL,
    [fecha_nacimiento]     DATE          NULL,
    [num_seguridad_social] VARCHAR (20)  NULL,
...
CREATE TABLE [dbo].[Dim_Tiempo] (
    ...
    PRIMARY KEY CLUSTERED ([idFecha] ASC)
);
...
GO
ALTER TABLE [dbo].[Fact_Visitas] WITH NOCHECK
    ADD FOREIGN KEY ([DNI_Paciente]) REFERENCES [dbo].[Dim_Paciente] ([DNI_Paciente]);
...
GO
ALTER TABLE [dbo].[Fact_Visitas] WITH NOCHECK
    ADD FOREIGN KEY ([DNI_Medico]) REFERENCES [dbo].[Dim_Medico] ([DNI_Medico]);
...
GO
ALTER TABLE [dbo].[Fact_Visitas] WITH NOCHECK
    ADD FOREIGN KEY ([fecha_hora]) REFERENCES [dbo].[Dim_Tiempo] ([idFecha]);
