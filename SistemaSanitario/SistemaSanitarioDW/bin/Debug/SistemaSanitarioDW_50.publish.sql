...
GO
/*
El tipo de la columna apellidos_nombre en la tabla [dbo].[Dim_Paciente] es  NVARCHAR (255) NULL, pero se va a cambiar a  VARCHAR (255) NULL. Si la columna contiene datos no compatibles con el tipo  VARCHAR (255) NULL, podrían producirse pérdidas de datos y errores en la implementación.
*/

IF EXISTS (select top 1 1 from [dbo].[Dim_Paciente])
    RAISERROR (N'Se detectaron filas. La actualización del esquema va a terminar debido a una posible pérdida de datos.', 16, 127) WITH NOWAIT

GO
PRINT N'Modificando Tabla [dbo].[Dim_Paciente]...';


GO
ALTER TABLE [dbo].[Dim_Paciente] ALTER COLUMN [apellidos_nombre] VARCHAR (255) NULL;


GO
PRINT N'Actualizando Procedimiento [dbo].[DW_MergeDimPaciente]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[DW_MergeDimPaciente]';
