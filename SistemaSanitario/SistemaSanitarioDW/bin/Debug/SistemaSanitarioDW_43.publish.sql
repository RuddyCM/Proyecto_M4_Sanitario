...
GO
PRINT N'Quitando Restricción UNIQUE restricción sin nombre en [dbo].[Dim_Servicio]...';


GO
ALTER TABLE [dbo].[Dim_Servicio] DROP CONSTRAINT [UQ__Dim_Serv__CEB981189E655F3F];
