...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK__Fact_Visi__Tiemp__5BE2A6F2];
...
CREATE TABLE [dbo].[tmp_ms_xx_Dim_Tiempo] (
    ...
    [semana]    INT  NULL,
    [dia_mes]   INT  NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Dim_Tiempo1] PRIMARY KEY CLUSTERED ([TiempoSK] ASC),
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Dim_Tiempo1]', N'PK_Dim_Tiempo', N'OBJECT';
