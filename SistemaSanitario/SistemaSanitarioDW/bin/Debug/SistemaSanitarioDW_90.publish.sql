...
BEGIN
    ...
    WHEN MATCHED THEN 
        ...
        SET fv.PacienteSK     = sv.PacienteSK,
            ...
            fv.fecha_hora     = sv.FechaHora,  -- Ahora es DATETIME en staging
            fv.fecha_alta     = sv.FechaAlta,  -- Ahora es DATE en staging
            fv.diagnostico    = sv.diagnostico,
            fv.tratamiento    = sv.tratamiento,
            fv.dias_ingreso   = sv.dias_ingreso

    WHEN NOT MATCHED THEN 
        INSERT (PacienteSK, MedicoSK, HospitalSK, ServicioSK,TiempoSK_FechaHora,TiempoSK_FechaAlta, num_habitacion, fecha_hora, fecha_alta, diagnostico, tratamiento, dias_ingreso)
        VALUES (sv.PacienteSK, sv.MedicoSK, sv.HospitalSK,sv.TiempoSK_FechaHora,sv.TiempoSK_FechaAlta, sv.ServicioSK,sv. sv.num_habitacion, 
                sv.FechaHora, -- Directo sin conversión
                sv.FechaAlta, -- Directo sin conversión
