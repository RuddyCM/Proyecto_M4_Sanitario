...
GO
/*
El tipo de la columna nombre_servicio en la tabla [dbo].[Dim_Servicio] es  NVARCHAR (255) NULL, pero se va a cambiar a  VARCHAR (255) NULL. Si la columna contiene datos no compatibles con el tipo  VARCHAR (255) NULL, podrían producirse pérdidas de datos y errores en la implementación.
*/
...
GO
PRINT N'Modificando Tabla [dbo].[Dim_Servicio]...';


GO
ALTER TABLE [dbo].[Dim_Servicio] ALTER COLUMN [nombre_servicio] VARCHAR (255) NULL;


GO
PRINT N'Actualizando Procedimiento [dbo].[DW_MergeDimServicio]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[DW_MergeDimServicio]';
