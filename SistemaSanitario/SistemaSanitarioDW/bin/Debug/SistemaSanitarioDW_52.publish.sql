...
GO
PRINT N'Quitando Restricción UNIQUE restricción sin nombre en [dbo].[Dim_Hospital]...';


GO
ALTER TABLE [dbo].[Dim_Hospital] DROP CONSTRAINT [UQ__Dim_Hosp__1573900A42558888];
