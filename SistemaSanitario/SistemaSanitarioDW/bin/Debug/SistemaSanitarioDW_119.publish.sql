...
GO
PRINT N'Quitando Clave externa [dbo].[FK_Dim_Paciente]...';


GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK_Dim_Paciente];


GO
PRINT N'Quitando Clave externa [dbo].[FK_Dim_Medico]...';


GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK_Dim_Medico];


GO
PRINT N'Quitando Clave externa [dbo].[FK_Dim_Hospital]...';


GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK_Dim_Hospital];


GO
PRINT N'Quitando Clave externa [dbo].[FK_Dim_Servicio]...';


GO
ALTER TABLE [dbo].[Fact_Visitas] DROP CONSTRAINT [FK_Dim_Servicio];
