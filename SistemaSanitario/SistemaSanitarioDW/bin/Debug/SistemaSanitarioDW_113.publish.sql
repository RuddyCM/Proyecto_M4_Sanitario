...
GO
ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [anio] INT NULL;

ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [dia] INT NULL;

ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [fecha] DATE NULL;

ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [mes] INT NULL;

ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [semana] INT NULL;

ALTER TABLE [dbo].[Dim_Tiempo] ALTER COLUMN [trimestre] INT NULL;
...
BEGIN
    ...
    -- 🚀 Insertamos los datos asegurando que 'TiempoSK' y 'dia_mes' no sean NULL
    INSERT INTO dbo.Dim_Tiempo(TiempoSK, fecha, anio, trimestre, mes, dia, semana, dia_mes)
    SELECT 
        -- Generamos un identificador único para TiempoSK basado en la fecha (YYYYMMDD)
        CONVERT(INT, FORMAT(dl.FullDate, 'yyyyMMdd')), 
        dl.FullDate,
        YEAR(dl.FullDate),
        ...
        DAY(dl.FullDate)  -- Aseguramos que 'dia_mes' no sea NULL
    FROM @datelist dl
