...
GO
ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [diagnostico] TEXT NULL;

ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [dias_ingreso] INT NULL;

ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [fecha_alta] DATE NULL;

ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [fecha_hora] DATETIME NULL;

ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [num_habitacion] INT NULL;

ALTER TABLE [dbo].[Fact_Visitas] ALTER COLUMN [tratamiento] TEXT NULL;
