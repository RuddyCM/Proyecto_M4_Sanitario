...
GO
ALTER TABLE [dbo].[Fact_Visitas] DROP COLUMN [TiempoSK];
...
GO
ALTER TABLE [staging].[Visitast] DROP COLUMN [TiempoSK];
...
BEGIN
    ...
    VALUES (sv.[VisitaSK], sv.[PacienteSK], sv.[MedicoSK], sv.[HospitalSK], sv.[num_habitacion], sv.[fecha_hora], sv.[fecha_alta], sv.[diagnostico], sv.[tratamiento], sv.[dias_ingreso]);
