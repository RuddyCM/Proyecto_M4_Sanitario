...
SET fv.PacienteSK     = sv.PacienteSK,
    ...
    fv.fecha_hora     = TRY_CONVERT(DATETIME, CAST(sv.TiempoSK_FechaHora AS CHAR(8)), 112),
    fv.fecha_alta     = TRY_CONVERT(DATE, CAST(sv.TiempoSK_FechaAlta AS CHAR(8)), 112),
...
VALUES (sv.PacienteSK, sv.MedicoSK, sv.HospitalSK, sv.ServicioSK, sv.num_habitacion, 
        TRY_CONVERT(DATETIME, CAST(sv.TiempoSK_FechaHora AS CHAR(8)), 112),
        TRY_CONVERT(DATE, CAST(sv.TiempoSK_FechaAlta AS CHAR(8)), 112),
