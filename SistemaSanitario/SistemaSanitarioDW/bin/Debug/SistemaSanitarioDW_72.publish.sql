...
BEGIN
    ...
    USING (
        SELECT 
            VisitaSK, PacienteSK, MedicoSK, HospitalSK, ServicioSK, num_habitacion,
            TRY_CONVERT(DATETIME, FORMAT(TiempoSK_FechaHora, '00000000'), 112) AS FechaHora,
            TRY_CONVERT(DATE, FORMAT(TiempoSK_FechaAlta, '00000000'), 112) AS FechaAlta,
            diagnostico, tratamiento, dias_ingreso
    ...
    VALUES (sv.PacienteSK, sv.MedicoSK, sv.HospitalSK, sv.ServicioSK, sv.num_habitacion, 
            sv.FechaHora, sv.FechaAlta, sv.diagnostico, sv.tratamiento, sv.dias_ingreso);
